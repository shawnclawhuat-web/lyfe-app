...
export default function EventDetailScreen() {
    ...
    const myCounts = useMemo(
        () => (myAttendance ? activityCounts(myAttendance.user_id) : { sitdowns: 0, pitches: 0, closed: 0, afyc: 0 }),
        [myAttendance?.user_id, activityCounts],
    );
            ...
            {roadshowConfig ? (
                <>
                    <View style={rsStyles.costRow}>
                        ...
                        <Text style={[rsStyles.costValue, { color: colors.textPrimary }]}>
                    ...
                    <View style={rsStyles.costRow}>
                        ...
                        <Text style={[rsStyles.costValue, { color: ROADSHOW_PINK, fontWeight: '700' }]}>
                ...
                <>
                    ...
                    <View style={rsStyles.targetsRow}>
                        <View style={rsStyles.targetCell}>
                            <Text style={[rsStyles.targetNum, { color: ROADSHOW_PINK }]}>
            ...
            {leaderboard.map((agent, i) => {
                ...
                return (
                    ...
                    >
                        ...
                        <Text
                            style={[rsStyles.lbName, { color: colors.textPrimary, fontWeight: isSelf ? '700' : '500' }]}
                            numberOfLines={1}
                            ellipsizeMode="tail"
                        >
                            {agent.full_name ?? '?'}
            ...
            <View style={[styles.card, { backgroundColor: colors.cardBackground }]}>
                ...
                {feed.map((act) => (
                    <View key={act.id} style={rsStyles.feedRow}>
                        <Text style={[rsStyles.feedTime, { color: colors.textTertiary }]}>
                        ...
                        />
                        <Text style={[rsStyles.feedName, { color: colors.textPrimary }]} numberOfLines={1}>
                            {act.full_name}
                        </Text>
        ...
        return (
            <View style={[styles.card, { backgroundColor: colors.cardBackground }]}>
                <View style={rsStyles.sectionHeaderRow}>
                    ...
                    <Text style={[rsStyles.countBadge, { color: colors.textTertiary }]}>
                        {checkedInCount} / {totalAgents}
                    </Text>
                </View>
                        ...
                        <View key={agent.id} style={[rsStyles.agentCard, { backgroundColor: colors.surfaceSecondary }]}>
                            <View style={rsStyles.agentHeader}>
                                <Avatar
                                    ...
                                    textColor={ac}
                                />
                                <Text style={[rsStyles.agentName, { color: colors.textPrimary }]}>
                                    {agent.full_name}
                                </Text>
                                {!att && (
                                    <TouchableOpacity
                            ...
                            {att ? (
                                <>
                                    ...
                                    <View style={[rsStyles.agentStatsTable, { marginTop: 10 }]}>
                                        ...
                                        >
                                            <Text style={[rsStyles.agentBandLabel, { color: colors.textTertiary }]}>
                                                TARGET
                                            </Text>
                                            <View style={rsStyles.agentBandRow}>
                                                <View style={rsStyles.agentBandCol}>
                                                    <Text
                                                        style={[rsStyles.agentBandNum, { color: colors.textSecondary }]}
                                                    >
                                        ...
                                        <View style={rsStyles.agentStatsBand}>
                                            <Text style={[rsStyles.agentBandLabel, { color: colors.textSecondary }]}>
                                                ACTUAL
                                            </Text>
                                            <View style={rsStyles.agentBandRow}>
                                                <View style={rsStyles.agentBandCol}>
                ...
                {hasDeparted && (
                    <View style={{ gap: 8 }}>
                        <View style={rsStyles.departedBadge}>
                            ...
                            <Text style={[rsStyles.leaveBtnText, { color: colors.textTertiary }]}>
                                You left the booth
                            </Text>
                        </View>
                        <TouchableOpacity
        ...
        <View style={[styles.card, { backgroundColor: colors.cardBackground }]}>
            ...
            {attendance.map((att) => {
                ...
                return (
                    <View key={att.id} style={rsStyles.pastTableRow}>
                        <Text style={[rsStyles.pastCellName, { color: colors.textPrimary }]} numberOfLines={1}>
                            {att.full_name}
                        </Text>
                        <Text style={[rsStyles.pastCellNum, { color: colors.textPrimary }]}>
                            {counts.sitdowns}/{att.pledged_sitdowns}
                        </Text>
                        <Text style={[rsStyles.pastCellNum, { color: colors.textPrimary }]}>
                            {counts.pitches}/{att.pledged_pitches}
            ...
            {attendance.length > 0 && (
                <View style={[rsStyles.pastTableRow, rsStyles.pastTotalRow, { borderTopColor: colors.border }]}>
                    ...
                    <Text style={[rsStyles.pastCellNum, { color: colors.textPrimary, fontWeight: '700' }]}>
                    ...
                    <Text style={[rsStyles.pastCellAfyc, { color: '#F59E0B', fontWeight: '700' }]}>
                        ${boothTotals.afyc.toLocaleString()}
                    </Text>
                </View>
            )}
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                        ...
                        {isLive && (
                            <View style={[rsStyles.livePill, { backgroundColor: '#22C55E18' }]}>
                                <Animated.View
                                    style={[rsStyles.liveDot, { backgroundColor: '#22C55E', opacity: liveAnim }]}
                                />
                                ...
                                {ATTENDEE_ROLE_ORDER.filter((r) => grouped[r].length > 0).map((role) => (
                                    <View key={role} style={styles.roleGroup}>
                                        ...
                                        {grouped[role].map((a) => {
                                            const ac =
                                                AVATAR_COLORS[
                                                    (a.full_name ?? '?').charCodeAt(0) % AVATAR_COLORS.length
                                                ];
                                            return (
                                                <View key={a.id} style={styles.attendeeRow}>
                                                    ...
                                                    <View
                                                        style={[
                                                            ...
                                                            {
                                                                backgroundColor:
                                                                    ATTENDEE_ROLE_COLORS[a.attendee_role] + '18',
                                                            },
                                                        ]}
                                                    >
                                                        <Text
                                                ...
                                                <View key={i} style={styles.attendeeRow}>
                                                    ...
                                                    <View
                                                        style={[
                                                            ...
                                                            {
                                                                backgroundColor:
                                                                    (ATTENDEE_ROLE_COLORS[a.attendee_role] ??
                                                                        '#8E8E93') + '18',
                                                            },
                                                        ]}
                                                    >
                ...
                <SafeAreaView style={[styles.sheetContainer, { backgroundColor: colors.background }]}>
                    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
                        ...
                        <ScrollView contentContainerStyle={styles.sheetContent}>
                            ...
                            {(
                                ...
                                <View key={key} style={rsStyles.pledgeRow}>
                                    ...
                                    <View style={rsStyles.pledgeStepperRow}>
                                        <TouchableOpacity
                                            style={[rsStyles.stepBtn, { backgroundColor: colors.surfaceSecondary }]}
                            ...
                            <View style={styles.field}>
                                <Text style={[rsStyles.pledgeLabel, { color: colors.textSecondary }]}>
                                    AFYC target ($)
                                </Text>
                                <TextInput
                                    style={[
                    ...
                    return (
                        <View style={rsStyles.confirmOverlay}>
                            ...
                            >
                                ...
                                <Text style={[rsStyles.confirmTitle, { color: colors.textPrimary }]}>
                                    Log {cfg.label}?
                                </Text>
                                ...
                                <TouchableOpacity
                                    style={rsStyles.confirmCancel}
                                    onPress={() => setConfirmActivity(null)}
                                >
                                    <Text style={[rsStyles.confirmCancelText, { color: colors.textSecondary }]}>
                                        Cancel
                                    </Text>
                                </TouchableOpacity>
                            </View>
                ...
                <SafeAreaView style={[styles.sheetContainer, { backgroundColor: colors.background }]}>
                    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
                        ...
                        <View style={styles.sheetContent}>
                            <Text style={[rsStyles.pledgeLabel, { color: colors.textSecondary, marginBottom: 6 }]}>
                                AFYC Amount ($)
                            </Text>
                            <TextInput
                                style={[
                            ...
                            <TouchableOpacity
                                style={[
                                    rsStyles.checkinBtn,
                                    { backgroundColor: '#F59E0B', marginTop: 12, opacity: loggingActivity ? 0.6 : 1 },
                                ]}
