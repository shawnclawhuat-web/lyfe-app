...
export default function LoginScreen() {
    ...
    const { signInWithOtp, verifyOtp, pendingBiometricSession, authenticateWithBiometrics, biometricsEnabled } =
        useAuth();
                        ...
                        <View style={styles.content}>
                            ...
                            <Animated.View style={[styles.formContainer, { opacity: fadeAnim }]}>
                                {step === 'welcome' ? (
                                        ...
                                        >
                                            ...
                                            <TextInput
                                                ...
                                                onChangeText={(text) => {
                                                    ...
                                                    setPhone(
                                                        truncated.length > 4
                                                            ? `${truncated.slice(0, 4)} ${truncated.slice(4)}`
                                                            : truncated,
                                                    );
                                                    setError(null);
                                                }}
                                    ...
                                    <>
                                        <Text style={[styles.heading, { color: OVERLAY_TEXT }]}>
                                            Verify your number
                                        </Text>
                                        <Text style={[styles.subheading, { color: OVERLAY_TEXT_MUTED }]}>
