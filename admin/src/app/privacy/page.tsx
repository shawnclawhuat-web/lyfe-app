    ...
    <main className="mx-auto max-w-2xl px-6 py-16">
      ...
      <div className="mt-10 space-y-8 text-[15px] leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-2 text-muted-foreground">
            Your data is stored securely on Supabase-hosted infrastructure with
            encryption at rest and in transit. We implement appropriate technical
        ...
        <section>
          ...
          <p className="mt-2 text-muted-foreground">
            We do not sell your personal data. Information may be shared within
            your agency hierarchy (e.g. managers can view their team
            members&apos; activity) as part of the app&apos;s core functionality.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2 text-muted-foreground">
            ...
            you of any material changes through the app or by other means.
          </p>
        </section>
