...
export default function SupportPage() {
    return (
        <main className="mx-auto max-w-2xl px-6 py-16">
            ...
            <p className="mt-4 text-muted-foreground">Need help with Lyfe? We&apos;re here for you.</p>
                    ...
                    <dl className="mt-3 space-y-4">
                        <div>
                            ...
                            <dd className="mt-1 text-sm text-muted-foreground">
                                Contact our support team and we&apos;ll help you regain access to your account.
                            </dd>
                        </div>
                        <div>
                            <dt className="font-medium">How do I report a bug or request a feature?</dt>
                            <dd className="mt-1 text-sm text-muted-foreground">
                                Email us at the address above with a description of the issue or your feature request.
                            </dd>
                        </div>
                    </dl>
                </div>
