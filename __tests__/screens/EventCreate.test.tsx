...
beforeEach(() => {
  ...
  (useRouter as jest.Mock).mockReturnValue({
    push: jest.fn(), replace: mockReplace, back: mockBack,
  });
...
describe('CreateEventScreen', () => {
  ...
  it('shows event type options', async () => {
    ...
    await waitFor(() => {
      ...
      expect(getByText('Agency Event')).toBeTruthy();
  ...
  it('renders in edit mode when eventId param is present', async () => {
    ...
    (fetchEventById as jest.Mock).mockResolvedValue({
      data: {
        id: 'evt-1', title: 'Existing Event', description: 'Desc',
        event_type: 'team_meeting', event_date: '2026-03-20',
        start_time: '09:00', end_time: '10:00', location: 'Office',
  ...
  it('loads event data in edit mode', async () => {
    ...
    (fetchEventById as jest.Mock).mockResolvedValue({
      data: {
        id: 'evt-1', title: 'Team Sync', description: 'Weekly',
        event_type: 'training', event_date: '2026-03-20',
        start_time: '09:00', end_time: '10:00', location: 'Room A',
